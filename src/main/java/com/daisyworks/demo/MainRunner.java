    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            try {
                ...
                System.err
                        .println("Did you mean to specify a port? Re-run me with something like: `java -jar <filename.jar> 8081` for example to run on port 8081; I am going to try port 8080 which is my default.");
            }
        }
